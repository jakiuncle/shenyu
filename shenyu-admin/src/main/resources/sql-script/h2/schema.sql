...
INSERT IGNORE INTO `plugin` (`id`, `name`, `role`, `sort`, `enabled`) VALUES ('39', 'auth', 'Authentication', 40, '0');
...
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('1529402639284355100', '1346775491550474240', 'auth', 'auth', '/plug/auth', 'auth', 1, 0, 'block', 0, 0, '', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('1529402639372435663', '1529402639284355100', 'SHENYU.BUTTON.PLUGIN.SELECTOR.ADD', '', '', '', 2, 0, '', 1, 0, 'plugin:authSelector:add', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('1529402639372435664', '1529402639284355100', 'SHENYU.BUTTON.PLUGIN.SELECTOR.QUERY', '', '', '', 2, 0, '', 1, 0, 'plugin:authSelector:query', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('1529402639372435665', '1529402639284355100', 'SHENYU.BUTTON.PLUGIN.SELECTOR.EDIT', '', '', '', 2, 0, '', 1, 0, 'plugin:authSelector:edit', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('1529402639372435666', '1529402639284355100', 'SHENYU.BUTTON.PLUGIN.SELECTOR.DELETE', '', '', '', 2, 0, '', 1, 0, 'plugin:authSelector:delete', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('1529402639372435667', '1529402639284355100', 'SHENYU.BUTTON.PLUGIN.RULE.ADD', '', '', '', 2, 0, '', 1, 0, 'plugin:authRule:add', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('1529402639372435668', '1529402639284355100', 'SHENYU.BUTTON.PLUGIN.RULE.QUERY', '', '', '', 2, 0, '', 1, 0, 'plugin:authRule:query', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('1529402639372435669', '1529402639284355100', 'SHENYU.BUTTON.PLUGIN.RULE.EDIT', '', '', '', 2, 0, '', 1, 0, 'plugin:authRule:edit', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('1529402639372435670', '1529402639284355100', 'SHENYU.BUTTON.PLUGIN.RULE.DELETE', '', '', '', 2, 0, '', 1, 0, 'plugin:authRule:delete', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('1529402639372435671', '1529402639284355100', 'SHENYU.BUTTON.PLUGIN.SYNCHRONIZE', '', '', '', 2, 0, '', 1, 0, 'plugin:auth:modify', 1);
...
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`) VALUES ('1568879456483248858', '1346358560427216896', '1529402639284355100');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`) VALUES ('1568879456483248859', '1346358560427216896', '1529402639372435663');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`) VALUES ('1568879456483248860', '1346358560427216896', '1529402639372435664');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`) VALUES ('1568879456483248861', '1346358560427216896', '1529402639372435665');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`) VALUES ('1568879456483248862', '1346358560427216896', '1529402639372435666');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`) VALUES ('1568879456483248863', '1346358560427216896', '1529402639372435667');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`) VALUES ('1568879456483248864', '1346358560427216896', '1529402639372435668');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`) VALUES ('1568879456483248865', '1346358560427216896', '1529402639372435669');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`) VALUES ('1568879456483248866', '1346358560427216896', '1529402639372435670');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`) VALUES ('1568879456483248867', '1346358560427216896', '1529402639372435671');